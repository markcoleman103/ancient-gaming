...
const Mutation = {
    ...
    async createUser(parent, args) {
        let newUser = Object.assign(Object.assign({}, args.user), { id: Math.floor(Math.random() * 10000).toString() });
    ...
    async createBet(parent, args) {
        let newBet = Object.assign(Object.assign({}, args.bet), { id: Math.floor(Math.random() * 10000).toString(), win: false, payout: 0 });
        ...
        if (Math.random() < args.bet.chance) {
            ...
            await user.update({ balance: bestUser.balance + newBet.payout }, { where: { id: args.bet.userId } });
        }
